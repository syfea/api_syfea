...
var Login = /** @class */ (function (_super) {
    ...
    Login.prototype.render = function () {
        var _a = this.props, backgroundImage = _a.backgroundImage, classes = _a.classes, className = _a.className, loginForm = _a.loginForm, rest = __rest(_a, ["backgroundImage", "classes", "className", "loginForm"]);
