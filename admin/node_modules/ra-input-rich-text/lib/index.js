...
var RichTextInput = /** @class */ (function (_super) {
    ...
    RichTextInput.prototype.componentDidMount = function () {
        ...
        this.quill.on('text-change', debounce_1.default(this.onTextChange, 500));
    };
    RichTextInput.prototype.shouldComponentUpdate = function (nextProps) {
    ...
    RichTextInput.prototype.render = function () {
        ...
        return (react_1.default.createElement(FormControl_1.default, { error: error !== null && error != undefined, fullWidth: this.props.fullWidth, className: "ra-rich-text-input" },
